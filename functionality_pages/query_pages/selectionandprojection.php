<html>
    ...
    <body>
        ...
        <div class="page">
            ...
            <center>
                <h1>SELECT AND PROJECT</h1>
            </center>
            

            <div class="select-project">
                <center>
                    <form method="GET" action="selectionandprojection.php">
                    ...
                    <center>
                        <label for="columns">Attributes:</label>
                        <input type="text" name="columns">
                    </center>

                    <center>
                        <label for="attr">Condition:</label>
                        ...
                        <center>
                            <input type="submit" value = "Display" name="handleSelectionAndProjectionRequest">
                        </center>
                    </form>
                </center>
            </div>
