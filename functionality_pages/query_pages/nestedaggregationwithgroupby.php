    ...
    <body>
        <div class= "sidebar">
            ...
            <div class="page">
                ...
                <center>
                    <p>Find the names and levels of all hunters whose level is greater or equal to, for every boss, the average level of hunters that hunt said boss:</p>
                </center>

                <div class="nested">
                    <form method="GET" action="nestedaggregationwithgroupby.php">
                        <center>
                            <input type="hidden" id="GET" name="GET">
                            <input type="submit" value="Execute" name="handleNestedAggregationWithGroupByRequest">
                        </center>
                    </form>
                </div>
